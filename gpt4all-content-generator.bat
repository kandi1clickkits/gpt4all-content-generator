...
ECHO======================================================================================
SET KIT_NAME=gpt4all-content-generator
...
SET REPO_DOWNLOAD_URL=https://github.com/kandi1clickkits/gpt4all-content-generator/releases/download/v1.0.0/gpt4all-content-generator.zip
SET REPO_DEPENDENCIES_URL=https://github.com/kandi1clickkits/gpt4all-content-generator/raw/main/requirements.txt
SET REPO_NAME=gpt4all-content-generator.zip
SET EXTRACTED_REPO_DIR=gpt4all-content-generator
SET NOTEBOOK_NAME=GPT4All-Content_Generator.ipynb
SET MS_VC_REDIST_URL=https://aka.ms/vs/17/release/vs_BuildTools.exe
SET GET_PIP_LOCATION=https://bootstrap.pypa.io/get-pip.py
SET VIRTUALENV_NAME=gpt4all-content-generator-env
...
cd %EXTRACTED_REPO_DIR%/models
curl https://kandi.dev/owassets/kandi1clickkits-model-assets/gpt4all/gpt4all-lora-quantized-ggml.bin --output gpt4all-lora-quantized-ggml.bin >> !WORKING_DIR!\log.txt 2>&1
IF ERRORLEVEL 1 (
	CALL :LOG "Error with Downloading Model checkpoint from source ... "
    	EXIT /B 1
)
